...
// // //       const res = await fetch(`http://localhost:5000/api/pcos?${query}`);
...
// // //     e.preventDefault();
// // //     try {
// // //       const res = await fetch("http://localhost:5000/api/pcos", {
// // //         method: "POST",
...
// // // Mask name: show first 2 letters + ***
// // const maskName = (str) => {
// //   if (!str) return "";
// //   return str.length <= 2 ? str + "***" : str.slice(0, 2) + "***";
// // };

// // // Show email username but replace domain with @gmail.com
...
// // Mask email: first 3 letters of username + *** + @gmail.com
// const maskEmailDomain = (email) => {
//   if (!email) return "";
//   const [user] = email.split("@");
