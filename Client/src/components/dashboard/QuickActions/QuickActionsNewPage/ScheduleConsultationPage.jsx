...
// // //   return (
// // //     <motion.div
// // //       className="p-6 max-w-xl mx-auto bg-white rounded-xl shadow-xl mt-10"
...
// // //           type="submit"
// // //           disabled={loading}
// // //           className="bg-purple-600 text-white font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-purple-700 transition w-full"
// // //         >
...
// // //           {/* 📋 Consultation List */}
// // //           <div className="mt-10">
// // //             <h3 className="text-lg font-semibold mb-3">🧾 Scheduled Consultations</h3>
...
// // //                     <p className="text-sm">{c.date} at {c.time}</p>
// // //                     {c.notes && (
...
// //       {/* Lock scheduling form behind password */}
// //       {!isAuthenticated ? (
...
//                 className="border p-3 rounded-md shadow-sm bg-gray-50"
//               >
//                 <p className="font-medium">{maskName(c.name)}</p>
//                 <p className="text-sm">
//                   {c.date} at {c.time}
//                 </p>
//                 {c.notes && <p className="text-sm text-gray-600 mt-1">{c.notes}</p>}
