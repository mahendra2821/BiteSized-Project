...
//         <h2 className="text-xl font-bold">Weekly Client Plans</h2>
//         <button
//           onClick={() => setView(view === "list" ? "chart" : "list")}
//           className="bg-gray-700 text-white px-4 py-2 rounded"
//         >
//           Toggle: {view === "list" ? "Chart" : "List"}
//         </button>
//       </div>
...
//             <div
//               key={plan._id}
//               className="border rounded p-3 mb-3 shadow flex flex-col"
//             >
...
//   // 🔐 NEW: track if admin is authenticated
